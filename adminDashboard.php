...
<body>
    ...
    <nav>
        ...
        <a href="insertCabin.php">Add Cabin</a>
    </nav>
    ...
    if ($result && $result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<a class='back-button' href='updateCabin1.php?id=" . $row["cabinID"] . "'>Update </a>";
            echo "<a class='back-button' href='deleteCabin.php?id=" . $row["cabinID"] . "'>Delete</a>";
            echo "</div>";
